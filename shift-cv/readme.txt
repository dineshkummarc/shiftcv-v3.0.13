== Shift CV ==
Version: 3.0.13
Copyright: 2024, ThemeREX
WordPress version: required at least 4.5, tested up to 6.6.1
...
Please install and activate it before starting to use the theme Shift CV.
Also the theme supports many popular plugins such as 'Elementor', 'Revolution Slider' and many more.
They can be installed after theme activation from the menu 'Theme Panel->Theme Dashboard->Plugins'.


III. Documentation

Theme documentation is available on https://shift-cv.themerex.net/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Shift CV is Fontello.
...
2) js/colorpicker/*.js
   Copyright: Peter Dematté
   Resource URI: https://github.com/PitPik/tinyColorPicker
   License: MIT license (http://opensource.org/licenses/MIT)
   License URI: https://github.com/PitPik/tinyColorPicker/blob/master/LICENSE.md

3) js/theme.gallery/classie.js
   Resource URI: https://github.com/desandro/classie
   License: MIT license (http://opensource.org/licenses/MIT)
   License URI: http://desandro.mit-license.org/

4) js/theme.gallery/modernizr.js
   Resource URI: https://modernizr.com
   License: MIT & BSD license (http://opensource.org/licenses/MIT, https://opensource.org/licenses/bsd-license.php)
