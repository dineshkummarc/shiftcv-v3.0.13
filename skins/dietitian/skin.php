...
// Theme storage
//-------------------------------------------------------------------------
shift_cv_storage_set('theme_demo_url', '//dietitian.shift-cv.themerex.net');
...
if ( ! function_exists( 'shift_cv_skin_importer_set_options' ) ) {
	...
	function shift_cv_skin_importer_set_options($options = array()) {
		if (is_array($options)) {
			// Corporate demo
            $options['demo_type'] = 'dietitian';
			$options['files']['dietitian'] = $options['files']['default'];
			$options['files']['dietitian']['title'] = esc_html__('Dietitian Shift CV Demo', 'shift-cv');
			$options['files']['dietitian']['domain_demo'] = esc_url( 'https://dietitian.shift-cv.themerex.net' );   // Demo-site domain
		}
		return $options;
	}
}
