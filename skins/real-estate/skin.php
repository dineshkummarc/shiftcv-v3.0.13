...
// Theme storage
//-------------------------------------------------------------------------
shift_cv_storage_set('theme_demo_url', '//real-estate.shift-cv.themerex.net');
...
if ( ! function_exists( 'shift_cv_skin_importer_set_options' ) ) {
	...
	function shift_cv_skin_importer_set_options($options = array()) {
		if (is_array($options)) {
			// Corporate demo
            $options['demo_type'] = 'real-estate';
			$options['files']['real-estate'] = $options['files']['default'];
			$options['files']['real-estate']['title'] = esc_html__('Real Estate Shift CV Demo', 'shift-cv');
			$options['files']['real-estate']['domain_demo'] = esc_url( 'https://real-estate.shift-cv.themerex.net' );   // Demo-site domain
		}
		return $options;
	}
}
